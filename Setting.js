...
global.owner = process.env.OWNER_NUMBER  || '94784666782' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
global.timezone  = process.env.TIME_ZONE || 'Asia/Colombo/wellawaya' // ADD CORRECT TIMEZONE OR LEAVE IT SAME , OTHERWISE YOU GET ERROS
//=================================================================================


//======================[YOUR CHOICE, CHANGE OR LEAVE IT SAME]=====================
global.sudo  =  process.env.SUDO || "94784666782" ;          // DON'T REMOVE
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '02_06_2024_SIGMA_MD_k1CsjTNF_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'Senesh⃟_',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `Senesh_cm `, // ADD YOUR NAME
  ...
  packname:  process.env.PACK_NAME  || "Senesh" ,          // ADD YOUR STICKER PACKNAME
